...
## 1. 專案概述
本專案實現了一個基於離散狀態空間的強化學習 (Reinforcement Learning) 代理人，主要應用於井字遊戲 (Tic-Tac-Toe) 之策略訓練。核心技術採用近端策略優化 (PPO) 演算法，並結合Minimax演算法作為教練機制，解決強化學習在稀疏獎勵 (Sparse Reward) 環境下的收斂問題。
